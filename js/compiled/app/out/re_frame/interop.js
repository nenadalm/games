...
return [(function (){var pred__12561 = cljs.core.instance_QMARK_;
var expr__12562 = reactive_val;
if(cljs.core.truth_((pred__12561.cljs$core$IFn$_invoke$arity$2 ? pred__12561.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__12562) : pred__12561.call(null,reagent.ratom.RAtom,expr__12562)))){
return "ra";
} else {
if(cljs.core.truth_((pred__12561.cljs$core$IFn$_invoke$arity$2 ? pred__12561.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__12562) : pred__12561.call(null,reagent.ratom.RCursor,expr__12562)))){
return "rc";
} else {
if(cljs.core.truth_((pred__12561.cljs$core$IFn$_invoke$arity$2 ? pred__12561.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__12562) : pred__12561.call(null,reagent.ratom.Reaction,expr__12562)))){
return "rx";
} else {
if(cljs.core.truth_((pred__12561.cljs$core$IFn$_invoke$arity$2 ? pred__12561.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__12562) : pred__12561.call(null,reagent.ratom.Track,expr__12562)))){
return "tr";
} else {
return "other";
}
