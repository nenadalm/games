...
return [(function (){var pred__12840 = cljs.core.instance_QMARK_;
var expr__12841 = reactive_val;
if(cljs.core.truth_((pred__12840.cljs$core$IFn$_invoke$arity$2 ? pred__12840.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__12841) : pred__12840.call(null,reagent.ratom.RAtom,expr__12841)))){
return "ra";
} else {
if(cljs.core.truth_((pred__12840.cljs$core$IFn$_invoke$arity$2 ? pred__12840.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__12841) : pred__12840.call(null,reagent.ratom.RCursor,expr__12841)))){
return "rc";
} else {
if(cljs.core.truth_((pred__12840.cljs$core$IFn$_invoke$arity$2 ? pred__12840.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__12841) : pred__12840.call(null,reagent.ratom.Reaction,expr__12841)))){
return "rx";
} else {
if(cljs.core.truth_((pred__12840.cljs$core$IFn$_invoke$arity$2 ? pred__12840.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__12841) : pred__12840.call(null,reagent.ratom.Track,expr__12841)))){
return "tr";
} else {
return "other";
}
