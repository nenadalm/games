...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state,cljs.core.cst$kw$context,context),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$settings,cljs.core.cst$kw$game_DASH_area_SLASH_size], null),(function (p1__17067_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__17067_SHARP_,cljs.core.cst$kw$width,canvas.width,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$height,canvas.height], 0));
}));
} else {
 ...
 */
app.game_engine.start_game = (function app$game_engine$start_game(p__17068){
var map__17069 = p__17068;
var map__17069__$1 = (((((!((map__17069 == null))))?(((((map__17069.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__17069.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__17069):map__17069);
var settings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17069__$1,cljs.core.cst$kw$settings);
var game = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17069__$1,cljs.core.cst$kw$game);
var canvas = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17069__$1,cljs.core.cst$kw$canvas);
...
var G__17073 = cljs.core.first(event);
var G__17073__$1 = (((G__17073 instanceof cljs.core.Keyword))?G__17073.fqn:null);
switch (G__17073__$1) {
case "input":
...
break;
case "loop":
window.requestAnimationFrame((function (p1__17071_SHARP_){
return app.game_engine.game_state.cljs$core$IVolatile$_vreset_BANG_$arity$2(null,(function (){var G__17074 = app.game_engine.game_state.cljs$core$IDeref$_deref$arity$1(null);
var G__17075 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$loop,p1__17071_SHARP_], null);
return (app.game_engine.process_event_BANG_.cljs$core$IFn$_invoke$arity$2 ? app.game_engine.process_event_BANG_.cljs$core$IFn$_invoke$arity$2(G__17074,G__17075) : app.game_engine.process_event_BANG_.call(null,G__17074,G__17075));
})());
}));
...
break;
case "start":
window.requestAnimationFrame((function (p1__17072_SHARP_){
return app.game_engine.game_state.cljs$core$IVolatile$_vreset_BANG_$arity$2(null,(function (){var G__17076 = app.game_engine.game_state.cljs$core$IDeref$_deref$arity$1(null);
var G__17077 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$loop,p1__17072_SHARP_], null);
return (app.game_engine.process_event_BANG_.cljs$core$IFn$_invoke$arity$2 ? app.game_engine.process_event_BANG_.cljs$core$IFn$_invoke$arity$2(G__17076,G__17077) : app.game_engine.process_event_BANG_.call(null,G__17076,G__17077));
})());
}));
...
var G__17079_17081 = cljs.core.cst$kw$game_DASH_event;
var G__17080_17082 = (function (event){
...
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__17079_17081,G__17080_17082) : re_frame.core.reg_fx.call(null,G__17079_17081,G__17080_17082));
