...
var G__17060_17062 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$replace_DASH_canvas,canvas], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__17060_17062) : re_frame.core.dispatch.call(null,G__17060_17062));
...
var G__17061 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$game$input_SLASH_key_DASH_down,e.key], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__17061) : re_frame.core.dispatch.call(null,G__17061));
}
}));
} else {
return null;
...
var state = cljs.core.deref((function (){var G__17063 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$game_DASH_state], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__17063) : re_frame.core.subscribe.call(null,G__17063));
})());
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p,"State: ",state,(function (){var G__17064 = state;
var G__17064__$1 = (((G__17064 instanceof cljs.core.Keyword))?G__17064.fqn:null);
switch (G__17064__$1) {
case "stopped":
...
var G__17066 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$game_SLASH_resume,cljs.core.cst$kw$typing_DASH_race], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__17066) : re_frame.core.dispatch.call(null,G__17066));
}),cljs.core.cst$kw$on_DASH_blur,(function (){
var G__17067 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$game_SLASH_pause], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__17067) : re_frame.core.dispatch.call(null,G__17067));
